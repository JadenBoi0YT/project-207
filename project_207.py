...
try:
    ...
    car_model = get_blueprint_of_world.filter('vehicle.*')[0]
    ...
    if (location != "Location(x=66.648193, y=0.766224, z=0.162060)"):
        dropped_vehicle.apply_control(carla.VehicleControl(speed=0.4, reverse=True))
